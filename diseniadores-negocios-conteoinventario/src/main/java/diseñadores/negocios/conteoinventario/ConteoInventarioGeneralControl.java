...
public class ConteoInventarioGeneralControl {
    ...
    public void guardarProgresoAuditoria(ConteoInventarioGeneralDTO sesion) throws NegocioException {
        ...
        try {
            ...
            throw new NegocioException("Error al guardar el progreso de la auditoría en la base de datos.", e);
        }
    }
    ...
    public void registrarYAplicarAuditoriaGlobal(ConteoInventarioGeneralDTO sesion) throws NegocioException {
        ...
        try {
            ...
            throw new NegocioException("Error al cerrar la sesión de auditoría en la base de datos.", e);
        }
        ...
        for (ItemConteoDTO item : sesion.getTodosLosConteos()) {
            try {
                ...
                throw new NegocioException("Auditoría guardada, pero falló la sincronización para: " 
                        + item.getProductoCodigo(), e);
            }
        }
    }
    ...
    public void crearSesionAuditoria(ConteoInventarioGeneralDTO sesion) throws NegocioException {
        ...
        try {
            ...
            throw new NegocioException("Error crítico al registrar la sesión unificada de inventario en la base de datos.", e);
        }
    }
    ...
    public List<ConteoInventarioGeneralDTO> obtenerHistorialSesiones() throws NegocioException {
        try {
            ...
            throw new NegocioException("Error al recuperar el historial unificado de auditorías físicas.", e);
        }
    }
    ...
    public ConteoInventarioGeneralDTO buscarSesionPorCodigo(String codigoGeneral) throws NegocioException {
        ...
        try {
            ...
            throw new NegocioException("Error al consultar la sesión de auditoría: " + codigoGeneral, e);
        }
    }
